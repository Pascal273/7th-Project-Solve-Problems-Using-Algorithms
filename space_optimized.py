...
def create_top_profit_list(csv_dataset, budget):
    ...
    with open(
            f"Space optimized CSV Files/{file_name}.csv",
...
def get_best_combination(share_list, budget):
    ...
    # (1 dimensional array! Memory Use = Budget)
    ...
    for i in range(1, n + 1):
        for b in range(budget, 0, -1):
            ...
            # save the case with the greater profit
            # at the current position of the array
